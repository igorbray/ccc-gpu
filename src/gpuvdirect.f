     ...
     >   mintemp3,maxtemp3,tmp3,ltmin,minchilx,chilx,ctemp,itail,trat,
...
!      real,allocatable :: chitemp(:,:),tmp(:,:)
      ...
      logical second
      integer maxpsii
      real temp2(1:maxpsii,1:nqmi,nchi:nchtop)
      ...
      temp3(1:meshr,nchi:nchtop)=tmp3(1:meshr,nchi:nchtop)
